...
if ( ! function_exists( 'my_calendar_settings_page_init' ) ) {
    ...
    function my_calendar_render_settings_page() {
        ...
        <style>
            .tab-content { display: none; padding: 20px 0; border: none; } .tab-content.active { display: block; } .nav-tab-wrapper { margin-bottom: 0; } .settings-section { padding: 20px; border: 1px solid #ddd; background: #fff; margin-bottom: 20px;} .preview-mockup { transform: scale(0.9); transform-origin: top left; margin-top: 20px; font-family: sans-serif; }
            .style-block { border: 1px solid #ccd0d4; padding: 15px; margin-bottom: 20px; background: #fdfdfd; } .style-block h3 { margin-top: 0; padding-bottom: 10px; border-bottom: 1px solid #eee; display: flex; justify-content: space-between; align-items: center; }
            .color-picker-wrap { display: flex; align-items: center; gap: 8px; } .reset-color-btn { text-decoration: none; font-size: 18px; }
